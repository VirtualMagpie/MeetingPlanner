...
/**
 * Specification to search a reservation based on overlapping time.
 *
 * <ul>
 *   Ex :
 *   <li>search all reservations where 2021/05/03 9h->12h overlaps with reserve time (8h -> 10h
 *       overlaps / 10h -> 11h overlaps / 14h -> 16h does not overlap)
 *   <li>search all reservations which are not overlapping
 * </ul>
 */
