...
/**
 * Service principal pour la réservation, sélectionnant les meilleurs entités respectant les
 * contraintes de validation et enregistrant une réservation sur ces entités.
 */
@AllArgsConstructor
@Service
